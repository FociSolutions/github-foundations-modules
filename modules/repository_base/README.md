...
| <a name="input_github_repository_vulnerability_alerts"></a> [github\_repository\_vulnerability\_alerts](#input\_github\_repository\_vulnerability\_alerts) | Enables the github\_repository\_vulnerability\_alerts resource which explicitly manages Dependabot vulnerability alert enablement for the repository. Defaults to false. | `bool` | `false` | no |
